...
pub async fn get_mysql_client() -> MySqlPool {
    ...
    // Build and return the connection pool using MySqlPoolOptions
    MySqlPoolOptions::new()
        .max_connections(10)
        .connect(&database_url)
        .await
        .expect("Error building a MySQL database connection pool")
}